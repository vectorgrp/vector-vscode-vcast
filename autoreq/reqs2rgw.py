...
def cli():
    parser = argparse.ArgumentParser(description="Load a requirement file into the requirements gateway of a VectorCAST environment.")
    parser.add_argument("env_path", help="Path to the VectorCAST environment directory.")
    parser.add_argument("requirement_file", help="Path to the file containing requirements.")
    parser.add_argument("--gateway-path", help="Path to the file containing requirements.", default="generated_requirement_repository")
