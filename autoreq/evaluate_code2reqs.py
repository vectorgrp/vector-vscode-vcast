...
async def evaluate_environment(
    ...
    requirement_generator = RequirementsGenerator(
        env,
        extended_reasoning=extended_reasoning,
        combine_related_requirements=combined_related_requirements,
    )
    ...
    try:
        await asyncio.wait_for(
            perform_requirement_generation(), timeout=max_generation_time
        )
    ...
    print(
        [
            ...
            for func_name in requirement_sets.keys()
        ]
    )
