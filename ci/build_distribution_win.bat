...
curl -o clangd-windows-18.1.3.zip https://rds-vtc-docker-dev-local.vegistry.vg.vector.int:443/artifactory/rds-build-packages-generic-dev-local/code2reqs2tests/clangd/clangd-windows-18.1.3.zip
