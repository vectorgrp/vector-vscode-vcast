...
def main():
    parser = argparse.ArgumentParser(
        description='Export environments based on file paths.'
    )
    parser.add_argument(
        '--input-file', required=True, help='File containing environment paths'
    )
    parser.add_argument(
        '--output-dir', default='export', help='Directory to export environments to'
    )
    parser.add_argument(
        '--project-name',
        required=True,
        help='Name of the project folder in the export directory',
    )
    parser.add_argument(
        '--create-tar',
        action='store_true',
        help='Create a tarball of the exported environments',
    )
