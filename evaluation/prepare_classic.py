...
env_files = sorted(glob.glob("/home/thiscakeisalie/programming/data/msr4-product-vtt-only-r33-latest-requirements/vcast/MSR4_Product_VttOnly_R33_latest_requirements/build/*/*.env"))
...
with open("evaluation/classic/usable_envs.txt", "w") as f:
    f.write("\n".join(usable_envs))

with open("evaluation/classic/big_usable_envs.txt", "w") as f:
    import numpy as np
...
with open("evaluation/classic/coverage_data.json", "w") as f:
    import json
