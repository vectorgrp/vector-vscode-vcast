...
def main(input_path, requirements_output, references_output):
    ...
    for source_file in tqdm(source_files):
        try:
            ...
            func_defs += extract_function_defs(
                source_code, remembered_filepath=source_file
            )
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'requirements_output', help='Path to the output JSON file for requirements.'
    )
    parser.add_argument(
        'references_output',
        help='Path to the output JSON file for requirement references.',
    )
