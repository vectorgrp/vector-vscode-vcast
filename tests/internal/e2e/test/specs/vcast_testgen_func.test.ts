...
import {
  ...
  describe("vTypeCheck VS Code Extension", () => {
    ...
    it("should correctly generate all BASIS PATH tests for function", async () => {
      ...
      console.log("Generating all BASIS PATH tests for function DataBase::GetTableRecord")
    ...
    it("should correctly delete all BASIS PATH tests for function", async () => {
      await updateTestID();
      const envName = "cpp/unitTests/DATABASE-MANAGER"
      console.log("Deleting all BASIS PATH tests for function DataBase::GetTableRecord")
      await deleteAllTestsForFunction("database","DataBase::GetTableRecord", testGenMethod.BasisPath);
      console.log("Validating deletion of all BASIS PATH tests for function DataBase::GetTableRecord")
    ...
    it("should correctly generate all ATG tests for function", async () => {
      ...
      if (process.env["ENABLE_ATG_FEATURE"] === "TRUE"){
        console.log("Generating all ATG tests for function DataBase::GetTableRecord")
    ...
    it("should correctly delete all ATG tests for function", async () => {
      ...
      const envName = "cpp/unitTests/DATABASE-MANAGER"
      if (process.env["ENABLE_ATG_FEATURE"] === "TRUE"){
        console.log("Deleting all ATG tests for function DataBase::GetTableRecord")
        await deleteAllTestsForFunction("database","DataBase::GetTableRecord", testGenMethod.ATG);
        console.log("Validate deletion of all ATG tests for function DataBase::GetTableRecord")
        await validateTestDeletionForFunction(envName,"database","DataBase::GetTableRecord");
      }
      else{
        console.log("Skipping ATG tests")
    ...
    it("should correctly generate BASIS PATH tests by clicking on flask+ icon", async () => {
      await updateTestID();
      console.log("Generating all BASIS PATH tests for function DataBase::GetTableRecord using Flask icon")
    ...
    it("should correctly delete BASIS PATH tests generated by clicking on flask+ icon", async () => {
      await updateTestID();
      console.log("Deleting all BASIS PATH tests for function DataBase::GetTableRecord using Flask icon")
    ...
    it("should correctly generate ATG tests by clicking on flask+ icon", async () => {
      await updateTestID();
      if (process.env["ENABLE_ATG_FEATURE"] === "TRUE"){
        console.log("Generating all ATG tests for function DataBase::GetTableRecord using Flask icon")
    ...
    it("should correctly delete ATG tests generated by clicking on flask+ icon", async () => {
      await updateTestID();
      if (process.env["ENABLE_ATG_FEATURE"] === "TRUE"){
        console.log("Deleting all ATG tests for function DataBase::GetTableRecord using Flask icon")
        await deleteGeneratedTest("database","DataBase::GetTableRecord","ATG-TEST-1", 1)
        console.log("Validating deletion of all ATG tests for function DataBase::GetTableRecord using Flask icon")
