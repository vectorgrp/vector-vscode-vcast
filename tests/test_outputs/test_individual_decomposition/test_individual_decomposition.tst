...
TEST.NEW
TEST.NAME:AddPartyToWaitingList_BasicName_Success-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR24
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Tests that Add_Party_To_Waiting_List adds a party name to the waiting list and increments the size as required by FR24.
TEST.END_NOTES:
...
TEST.NEW
TEST.NAME:Test_Get_Head_Of_WaitingList_Returns_Correct_Name-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR25
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Verifies that Get_Next_Party_To_Be_Seated returns the name of the party at the head of the waiting list and increments the index.
TEST.END_NOTES:
...
TEST.SUBPROGRAM:Add_Party_To_Waiting_List
TEST.NEW
TEST.NAME:Test_Add_10_Parties_To_Waiting_List-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR23
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Adds 10 unique parties to the waiting list and verifies that all are stored and the size is 10, exercising the system's support for a waiting list of up to 10 parties.
TEST.END_NOTES:
TEST.VALUE:manager.<<GLOBAL>>.WaitingListSize:0
TEST.VALUE:manager.Add_Party_To_Waiting_List.Name:"Alpha"
TEST.EXPECTED:manager.<<GLOBAL>>.WaitingList[0]:"Alpha"
TEST.EXPECTED:manager.<<GLOBAL>>.WaitingListSize:1
TEST.END
...
Tests that WaitingListIndex is reset to 0 when it exceeds 9, and the correct party is returned from the start of the list. This exercises the requirement that the head of the waiting list is reset when it reaches the end.
TEST.END_NOTES:
...
TEST.NEW
TEST.NAME:Test_Check_Total_Unchanged_For_No_Entree_Order-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR17
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Verifies that placing an order with NO_ENTREE does not change the table's check total (i.e., increases it by 0.0) as per FR17.5.
TEST.END_NOTES:
...
Verifies that an order with steak, caesar salad, and mixed drink qualifies for a free pie (Dessert set to PIE).
TEST.END_NOTES:
...
Verifies that an order with lobster, green salad, and wine receives a free cake as dessert per FR27.2.
TEST.END_NOTES:
TEST.VALUE:manager.Add_Included_Dessert.Order:<<malloc 1>>
...
Test that Add_Included_Dessert does not modify Dessert when the order does not match any qualifying combination for a free dessert (FR27.3).
TEST.END_NOTES:
TEST.VALUE:manager.Add_Included_Dessert.Order:<<malloc 1>>
TEST.VALUE:manager.Add_Included_Dessert.Order[0].Salad:GREEN
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Place_Order_Steak_Increases_Check_Total_By_14-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR17
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Tests that placing an order with entree 'STEAK' increases the table's check total by 14.0 as required by FR17.1.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Test that placing an order with STEAK as the entree is supported and updates the table record and check total correctly.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Verifies that placing an order with entree 'lobster' increases the table's check total by 18.0 as required by FR17.3.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Test that placing an order with CHICKEN as the entree updates the table record correctly and increments the check total by $10.0, demonstrating support for chicken as an entree option.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Tests that placing an order with entree 'PASTA' increases the table's check total by 12.0 as required by FR17.4.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Test that placing an order with NO_ENTREE as the entree is supported and does not alter the check total or assign a dessert.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Test that placing an order with PASTA as the entree correctly updates the table record and check total, demonstrating support for pasta as an entree option.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Test that placing an order with LOBSTER as the entree correctly updates the table record and check total, demonstrating support for lobster as an entree option.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Check_Total_Increased_By_10_For_Chicken_Entree-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR17
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Verifies that placing an order with entree 'CHICKEN' increases the table's check total by 10.0 as required by FR17.2.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Test that Place_Order updates the specified seat's order in the table database as required by FR16.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Place_Order_At_Seat_3_Validates_4_Seats_Supported-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR12
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Place an order for seat 3 (the fourth seat) and verify that the system updates the correct seat, confirming support for 4 seats per table.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Verifies that Get_Check_Total returns the correct check total for a given table by using a stubbed Get_Table_Record with a known Check_Total value. This demonstrates that the system provides a way to obtain the check total for a table as required by FR22.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
...
Test that Clear_Table can be called for the highest supported table index (5), demonstrating support for 6 tables as required by FR11.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
Verifies that Clear_Table clears the orders for all seats of the table by setting all order fields to their NO_* values in the updated table record.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[3].Entree:PASTA
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[3].Dessert:CAKE
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[3].Beverage:SODA
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Check_Total:123.45
TEST.EXPECTED:uut_prototype_stubs.Update_Table_Record.Table:2
TEST.EXPECTED:uut_prototype_stubs.Update_Table_Record.Data.Order[0].Soup:NO_SOUP
...
Verifies that Clear_Table sets the table's occupied status to false by checking that Update_Table_Record is called with Is_Occupied = v_false, regardless of the initial value.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Clear_Table.Table:2
...
Test that Place_Order increments Number_In_Party by 1 when an order is placed, as required by FR15.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
Verifies that Clear_Table sets the table's check total to 0.0 in the table database by ensuring Update_Table_Record is called with Data.Check_Total = 0.0, regardless of the initial value.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Clear_Table.Table:2
...
TEST.SUBPROGRAM:Clear_Table
TEST.NEW
TEST.NAME:Test_Clear_Table_Updates_Number_In_Party_To_1-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR19
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Verifies that Clear_Table sets Number_In_Party to 1 in the table database, regardless of its previous value, as required by FR19.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Clear_Table.Table:2
...
Tests that placing an order for a table that is initially not occupied results in the table's occupied status being set to true in the database (via Update_Table_Record).
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
