...
TEST.SUBPROGRAM:Add_Included_Dessert
TEST.NEW
TEST.NAME:Test_Lobster_Green_Wine_Qualifies_For_Free_Cake-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR27
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.
...
TEST.SUBPROGRAM:Add_Included_Dessert
TEST.NEW
TEST.NAME:Test_Steak_Caesar_MixedDrink_Qualifies_For_Free_Pie-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR27
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.
...
Verifies that the waiting list supports up to 10 parties by adding a party when the list is at its maximum capacity (index 9), ensuring the 10th slot is used and the size does not exceed 10.
TEST.END_NOTES:
...
Verifies that a party can be added to the waiting list by specifying its name, and that the name is correctly stored in the next available slot.
TEST.END_NOTES:
...
Tests that when the WaitingListIndex exceeds the end of the waiting list (greater than 9), the head of the waiting list is reset to 0 and the correct party name is returned. This exercises the reset behavior required by FR26.1.
TEST.END_NOTES:
...
Verifies that after calling Clear_Table, the table's occupied status is set to false in the table database by checking the value passed to Update_Table_Record. This directly tests FR18.1.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Clear_Table.Table:2
...
Verifies that after calling Clear_Table, all order fields (Soup, Salad, Entree, Dessert, Beverage) for all seats are set to their NO_* values in the table database (via Update_Table_Record).
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
Verifies that after calling Clear_Table, the Number_In_Party field for the table is set to 1 in the table database (via Update_Table_Record), regardless of its previous value.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Clear_Table.Table:2
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Table_Occupied_Status_Updated_On_Place_Order-REVIEW-NEEDED
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Table_Number_In_Party_Incremented_On_Place_Order-REVIEW-NEEDED
...
Verifies that Place_Order can handle all 4 seat indices (0 to 3) for a table, as required by the system supporting 4 seats per table. This test places an order for each seat and checks that the correct seat's order is updated.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
Verifies that Place_Order supports all specified entree types: steak, chicken, lobster, pasta, and none. This test places an order for each entree and checks that the correct Check_Total is updated for each case.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
TEST.VALUE:manager.Place_Order.Order.Soup:NO_SOUP
TEST.VALUE:manager.Place_Order.Order.Salad:NO_SALAD
TEST.VALUE:manager.Place_Order.Order.Entree:STEAK,CHICKEN,LOBSTER,PASTA,NO_ENTREE
TEST.VALUE:manager.Place_Order.Order.Dessert:NO_DESSERT
TEST.VALUE:manager.Place_Order.Order.Beverage:NO_BEVERAGE
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.Table:2
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Is_Occupied:v_true
...
TEST.EXPECTED:uut_prototype_stubs.Update_Table_Record.Data.Check_Total:19.0,15.0,23.0,17.0,5.0
TEST.EXPECTED:uut_prototype_stubs.Update_Table_Record.Data.Order[1].Entree:STEAK,CHICKEN,LOBSTER,PASTA,NO_ENTREE
TEST.EXPECTED:manager.Place_Order.return:0,0,0,0,0
TEST.END

TEST.UNIT:manager
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Steak_Order_Increases_Check_Total-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR17
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.
...
Tests that placing an order for lobster increases the table's check total by 18.0. The test sets up a table with an initial check total, places a lobster order, and verifies that the check total is increased by 18.0 in the updated table record.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:3
...
Tests that placing an order for chicken increases the table's check total by 10.0. The test sets up a table with an initial check total, places a chicken order, and verifies that the check total is increased by 10.0 in the updated table record.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
