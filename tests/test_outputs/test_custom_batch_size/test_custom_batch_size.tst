...
TEST.NEW
TEST.NAME:Test_No_Free_Dessert_For_NonQualifying_Order-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR27
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Verifies that Add_Included_Dessert does not assign a free dessert when the order does not match any qualifying combination (STEAK+CAESAR+MIXED_DRINK or LOBSTER+GREEN+WINE). This tests FR27.3 by using an order with CHICKEN, GREEN salad, and SODA beverage, which should not result in a free dessert.
TEST.END_NOTES:
...
TEST.SUBPROGRAM:Add_Party_To_Waiting_List
TEST.NEW
TEST.NAME:Test_WaitingList_Maximum_Capacity_Reset-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR23
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Tests that the waiting list supports up to 10 parties and resets WaitingListSize to 0 when attempting to add an 11th party, ensuring the list does not exceed its maximum capacity.
TEST.END_NOTES:
TEST.VALUE:manager.<<GLOBAL>>.WaitingListSize:10
TEST.VALUE:manager.Add_Party_To_Waiting_List.Name:"Party11"
TEST.EXPECTED:manager.<<GLOBAL>>.WaitingListSize:1
TEST.EXPECTED:manager.<<GLOBAL>>.WaitingList[0]:"Party11"
TEST.END
...
Verifies that when an order is placed for steak with caesar salad and a mixed drink, the system sets the dessert to pie as required by FR27.1.
TEST.END_NOTES:
TEST.VALUE:manager.Add_Included_Dessert.Order:<<malloc 1>>
...
Verifies that when an order is placed for lobster with green salad and wine, the system sets the dessert to cake as required by FR27.2.
TEST.END_NOTES:
TEST.VALUE:manager.Add_Included_Dessert.Order:<<malloc 1>>
...
This test verifies that after calling Clear_Table, the table's check total is updated to 0.0 in the table database, regardless of its previous value. It simulates a table with a nonzero check total and checks that Update_Table_Record is called with Check_Total set to 0.0.
TEST.END_NOTES:
...
Tests that when the WaitingListIndex exceeds 9, it is reset to 0 and the head of the waiting list is returned from the start. This exercises the requirement that the head of the waiting list shall be reset when it reaches the end.
TEST.END_NOTES:
...
Tests that placing an order with entree STEAK increases the table's check total by 14.0 in the table database. The test sets up a table with a known check total, places a STEAK order, and checks that Update_Table_Record is called with the check total increased by 14.0.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Seat_Order_Updated_In_Table_Database-REVIEW-NEEDED
...
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[3].Entree:CHICKEN
...
Verifies that Clear_Table can be called with all valid table indices from 0 to 5, as required by the system supporting 6 tables. This test uses table index 5 (the highest valid index) to ensure the function operates correctly at the upper bound.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
...
Ensures that after calling Clear_Table, the Update_Table_Record stub is called with Is_Occupied set to v_false, confirming that the table's occupied status is cleared in the table database.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Clear_Table.Table:2
...
Verifies that Place_Order can handle all 4 seat indices (0 to 3) for a table, as required by FR12. This test places an order for each seat and checks that the correct seat's order is updated in the table data.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
Verifies that Place_Order supports all entree types: steak, chicken, lobster, pasta, and none. This test places an order for each entree and checks that the correct Check_Total is updated for each case.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
TEST.EXPECTED:uut_prototype_stubs.Update_Table_Record.Data.Order[1].Beverage:WINE
TEST.EXPECTED:uut_prototype_stubs.Update_Table_Record.Data.Order[1].Dessert:CAKE
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:PlaceOrder_UpdatesNumberInParty-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR15
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Tests that placing an order increments the table's number in party by 1 in the table database by verifying that Update_Table_Record is called with Number_In_Party increased.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Number_In_Party:2
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Designator:'B'
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Wait_Person:"Mary"
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Soup:NO_SOUP
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Salad:NO_SALAD
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Entree:NO_ENTREE
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Dessert:NO_DESSERT
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:PlaceOrder_UpdatesTableOccupiedStatus-REVIEW-NEEDED
...
Tests that placing an order with entree PASTA increases the table's check total by 12.0. The initial check total is set to 20.0, so after placing the order, the check total should be 32.0 in the updated table record.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Place_Order_Chicken_Increases_Check_Total_By_10-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR17
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Tests that placing an order with entree CHICKEN increases the table's check total by 10.0. The test sets up a table with an initial check total and verifies that after placing the order, the check total is increased by 10.0.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:2
...
Tests that placing an order with entree LOBSTER increases the table's check total by 18.0. The test sets up a table with an initial check total and verifies that after placing the order, the check total is increased by 18.0.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:3
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Place_Order_No_Entree_Does_Not_Increase_Check_Total-REVIEW-NEEDED
TEST.REQUIREMENT_KEY:FR17
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Tests that placing an order with entree NO_ENTREE does not increase the table's check total. The initial check total is set to 15.0, so after placing the order, the check total should remain 15.0 in the updated table record.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:3
...
Verifies that after calling Clear_Table, all order fields (Soup, Salad, Entree, Dessert, Beverage) for all seats are set to their NO_* values in the table database (i.e., in the data passed to Update_Table_Record).
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
Verifies that after calling Clear_Table, the table's Number_In_Party is set to 1 in the table database (i.e., in the data passed to Update_Table_Record).
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Clear_Table.Table:2
