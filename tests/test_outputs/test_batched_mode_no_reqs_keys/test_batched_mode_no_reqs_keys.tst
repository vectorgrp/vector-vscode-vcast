...
Tests that the waiting list supports up to 10 parties by adding a party when the list is at its maximum capacity (index 9), ensuring the party is added at the last slot and the size is updated correctly.
TEST.END_NOTES:
TEST.VALUE:manager.<<GLOBAL>>.WaitingListSize:9
TEST.VALUE:manager.Add_Party_To_Waiting_List.Name:"Smith"
TEST.EXPECTED:manager.<<GLOBAL>>.WaitingList[9]:"Smith"
...
Tests that when the WaitingListIndex is greater than 9, Get_Next_Party_To_Be_Seated resets the index to 0 and returns the name at the start of the list. This ensures the head of the waiting list is reset as required by FR26.1.
TEST.END_NOTES:
...
Tests that Get_Check_Total returns the correct check total for a given table by stubbing Get_Table_Record to return a known Check_Total value. This exercises the system's ability to provide the check total for a specified table as required by FR22.1.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
...
Tests that an order with a combination not matching the special cases does not qualify for a free dessert (dessert remains unchanged).
TEST.END_NOTES:
TEST.VALUE:manager.Add_Included_Dessert.Order:<<malloc 1>>
...
TEST.NEW
TEST.NAME:Test_Place_Order_None_Does_Not_Change_Check_Total-REVIEW-NEEDED
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.

Tested Requirement ID: FR17

Tests that placing an order for no entree (NO_ENTREE) does not increase the table's check total. The test sets up a table with an initial check total, places a NO_ENTREE order, and verifies that the check total remains unchanged in the data passed to Update_Table_Record.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
Tests that placing an order for pasta increases the table's check total by 12.0. The test sets up a table with an initial check total, places a pasta order, and verifies that the check total is incremented by 12.0 in the data passed to Update_Table_Record.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
Verifies that the system supports 4 seats per table by placing orders for all 4 seat indices (0 to 3) and ensuring the correct seat is updated in the table record.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
...
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Wait_Person:"Max"
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Entree:STEAK
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[1].Entree:CHICKEN
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[2].Entree:NO_ENTREE
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[3].Entree:NO_ENTREE
...
TEST.SUBPROGRAM:Place_Order
TEST.NEW
TEST.NAME:Test_Support_For_All_Entree_Types-REVIEW-NEEDED
TEST.NOTES:
WARNING: This test case was generated by an AI-based system. Please review it carefully.
...
Tests that placing an order updates the correct seat's order in the table database. The test sets up a table with no order for seat 2, places a new order for seat 2, and checks that Update_Table_Record is called with the new order for seat 2.
TEST.END_NOTES:
TEST.STUB:uut_prototype_stubs.Get_Table_Record
TEST.STUB:uut_prototype_stubs.Update_Table_Record
TEST.VALUE:manager.Place_Order.Table:1
...
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[3].Dessert:NO_DESSERT
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[3].Beverage:NO_BEVERAGE
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Check_Total:35.0
TEST.EXPECTED:uut_prototype_stubs.Update_Table_Record.Data.Check_Total:45.0
TEST.END
...
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Number_In_Party:4
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Designator:'D'
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Wait_Person:"Anna"
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Soup:NO_SOUP
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Salad:NO_SALAD
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Entree:NO_ENTREE
TEST.VALUE:uut_prototype_stubs.Get_Table_Record.return.Order[0].Dessert:NO_DESSERT
