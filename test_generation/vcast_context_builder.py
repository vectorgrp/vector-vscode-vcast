...
class VcastContextBuilder:
    def __init__(self, test_environment_manager, requirement_locator):
        self.test_environment_manager = test_environment_manager
    ...
    async def build_code_context(self, requirement_id, reduce_context=False):
        ...
        for unit_name, unit_path in zip(unit_names, unit_paths):
            ...
            if env is not None:
                env_dir = os.path.dirname(env.env_file_path)
